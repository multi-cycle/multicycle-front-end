...
const CreateTask = () => {
    ...
    const [bounty_name_, set_bounty_name_] = useState("")
    ...
    const SubmitCreate = () =>{
      ...
      if(url!==""){
        ...
        const bounty_url = url;
        const bounty_state = "Review";
        const participants_number = "0"
        const submissions_number = "0"
        const insert_time = "2022/3/20";
        const update_time = "2022/3/31";
        const bounty_level = git_level;
        const bounty_finish_nft_image = finish_nft_image;
        const bounty_content = content;
        const bounty_name = bounty_name_
        axios.post('http://localhost:3004/api/create_bounty', {
            github_user_name,
            bounty_url,
            bounty_state,
            participants_number,
                ...
                <div className="bg-black bg-opacity-90 mx-auto">
                        ...
                        <div className="mt-16 text-base md:text-xl">
                            <div className="bg-gray-700 bg-opacity-20 text-white rounded-3xl  cursor-auto p-10   ">
                              <div className=" mb-10 flex">
                                ...
                                <div className={classNames(level_color[git_level])}> {bounty_name_}</div>
                              </div>
                  ...
                  <img className="rounded-2xl" src={finish_nft_image} alt=""/>
                    ...
                    <Transition.Root show={error} as={Fragment}>
                        <Dialog as="div" className="fixed z-20 inset-0 overflow-y-auto" onClose={closeError}>
                            <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                <Transition.Child
                                  as={Fragment}
                                  enter="ease-out duration-300"
                                            ...
                                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                ...
                                                <div className="mt-2">
                                                    <p className="text-sm text-gray-500">
                                                        Please recheck your network and URL
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
