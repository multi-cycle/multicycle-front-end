...
const BountyReview = () => {
  ...
  useEffect(() => {
    const fetchUserBounty = async () => {
      const data = await axios.get('http://localhost:3004/api/get_claim_bounty_review_all', {
        params: {
          ...
          <div className="bg-black bg-opacity-90 mx-auto">
            <div className="max-w-7xl relative px-5 py-16  sm:px-6 sm:py-24 lg:py-32 mx-auto ">
              <div className=" mb-32">
                ...
                <div
                  className={bountyreview.length ? "hidden" : "mt-16 flex md:grid md:grid-cols-2 gap-4  xl:grid xl:grid-cols-3 gap-4 xl:gap-10 overflow-x-auto md:overflow-visible"}>
                  <a href=''>
                    <div
              ...
              <div className={bountyreview.length ? "" : "hidden"}>
                <Sort />
              </div>
            </div>
          </div>
