...
const CompletedBounty = () => {
  ...
  useEffect(() => {
    const fetchUserBounty = async () => {
      const data = await axios.get('http://localhost:3004/api/get_claim_bounty_complete_all', {
        params: {
        ...
        <div className="relative pt-16">
          ...
          <div className="bg-black bg-opacity-90 mx-auto">
            <div className="max-w-7xl relative px-5 py-16  sm:px-6 sm:py-24 lg:py-32 mx-auto ">
              ...
              <div className={completedbounty.length ? "" : "hidden"}>
                <Sort />
              </div>
            </div>
          </div>
...
export default CompletedBounty
