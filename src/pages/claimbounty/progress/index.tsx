      ...
      <div className="relative pt-16">
        ...
        <div className="bg-black bg-opacity-90 mx-auto">
          ...
          <Transition.Root show={submit} as={Fragment}>
            <Dialog as="div" className="fixed z-20 inset-0 overflow-y-auto "  onClose={closure}>
              <div className="flex items-end justify-center min-h-screen pt-4  px-4 pb-20 text-center sm:block sm:p-0">
                <Transition.Child
                  as={Fragment}
                  enter="ease-out duration-300"
                ...
                >
                  <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                    <div className="text-center">
                      ...
                      <div className="mt-5  ">
                        <input type="text"
                               className="bg-gray-700 bg-opacity-30 text-xs md:text-sm   rounded-2xl p-2 w-full  border-black  border hover:border-white focus:border-white transition duration-300  outline-none"
                               placeholder=" Bound URL"
                               id="user_url"
                        />
                      </div>
                      <button onClick={Submiturl} className="px-5 py-2 text-black  mt-5  bg-gradient-to-r from-blue-300  to-red-300 rounded-2xl">
                       Submit
                      </button>
                    </div>
                  </div>
